  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content={`${config.title} - Contact Us`}
        ></meta>
      </Head>
      <div className="container">
        <h1 className="title">Contact Us</h1>
        <p className="description">
          If you have a question about an order already placed, please include
          your order number in the message.
        </p>
        ...
        <form onSubmit={e => handleSubmit(e, setShow)}>
          ...
          <Button variant="button" disabled={show}>
            Send
          </Button>
        </form>
      </div>
