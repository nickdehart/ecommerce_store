...
const Privacy = ({config}) => (
  <div>
   ...
   <div className="container add-margin">
      This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase at Get Ur Tools Out.
      <br />
      ...
      <br /> The Site is not intended for individuals under the age of 18.
      <br />
      <br /> <strong>Contact us</strong>
      <br /> For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us.
   </div>
